...
public class HexWorld {
    ...
    public static void main(String[] args) {
        ...
        HexagonStructureBuilder builder = new HexagonStructureBuilder(4, 5, 1);
    ...
    private static class HexagonStructureBuilder {
        ...
        HexagonStructureBuilder(int sizeOfHexagon, int numberOfHexInCenter, int numberOfHexAtSides) {
        ...
        public void addHexagonStack(int x, int y, int numberOfHex) {
            for (int currNumberHex = 0; currNumberHex < numberOfHex; currNumberHex++) {
                Hexagon.addHexagon(sizeOfHexagon, x, y);
                y += 2 * sizeOfHexagon;
            }
        }
    }
